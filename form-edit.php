  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SSIP Project</div>
      </a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Data Student</h1>
          </div>
          <?php 
            include_once "connection.php";
            $studentID = $_GET['studentID'];
            $result = mysqli_query($connection, "SELECT * FROM mst_student WHERE studentID='$studentID'");
          ...
          <form method="post" action="edit.php">
            <div class="form-group">
              ...
              value="<?php echo $data['studentName']; ?>">
              <input type="hidden" name="studentID" id="" class="form-control" placeholder="" aria-describedby="helpId"
              value="<?php echo $data['studentID']; ?>">
            </div>
